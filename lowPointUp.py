...
if __name__ == '__main__':
    ...
    if bsApi.isLogin:
        ...
        now_date_time = datetime.datetime.now() + datetime.timedelta(days=-2)
        ...
        if len(codes_code_list) > 0:
            for code in codes_code_list:
                ...
                if now_price <= low_close_price_4 and mad_5 / mad_20 > 1 and mad_5_pre_1 / mad_20_pre_1 < 1 and mad_5_angle > mad_20_angle >= 10:

                    print("low_close_price_4:%s" % low_close_price_4)
                    SqlAction.insert_low_point_up(first_array, low_close_price_4, '', '')
                elif low_close_price_4 < now_price <= low_close_price_8 and mad_5 / mad_20 > 1 and mad_5_pre_1 / mad_20_pre_1 < 1 and mad_5_angle > mad_20_angle >= 10:
                    print("low_close_price_4:%s" % low_close_price_8)
                    SqlAction.insert_low_point_up(first_array, '', low_close_price_8, '')
                elif low_close_price_8 < now_price <= low_close_price_10 and mad_5 / mad_20 > 1 and mad_5_pre_1 / mad_20_pre_1 < 1 and mad_5_angle > mad_20_angle >= 10:
